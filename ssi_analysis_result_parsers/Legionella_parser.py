...
# %% auto 0
__all__ = ['extract_legionella_sbt', 'legionella_summary', 'legionella_summary_batch', 'legionella_parser']
...
def legionella_summary_batch(file_paths: dict, output_file: Path):
    results_list = []
    for sample_name, path_dict in file_paths:
        legionella_results = legionella_summary(
            legionella_sbt_results_tsv=path_dict["sbt_results"],
            lag1_blast_tsv=["lag1_blast_results"],
        )
        results_list.append({sample_name: legionella_results})
