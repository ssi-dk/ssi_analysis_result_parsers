# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/49_Ecoli_parser_old.ipynb.

# %% auto 0
__all__ = ['thresholds', 'samplesheet_path', 'output_path', 'results_obj', 'test_cases', 'setup_logging', 'get_threshold',
           'process_res_file', 'EcoliResults', 'ecoli_parser']

# %% ../nbs/49_Ecoli_parser_old.ipynb 3
import os
import sys
import pandas as pd
...
# %% ../nbs/49_Ecoli_parser_old.ipynb 6
thresholds = {
    "stx": [98, 98],
    "wzx": [98, 98],
    "wzy": [98, 98],
...
# %% ../nbs/49_Ecoli_parser_old.ipynb 9
...
# %% ../nbs/49_Ecoli_parser_old.ipynb 11
...
# %% ../nbs/49_Ecoli_parser_old.ipynb 13
class EcoliResults:
    """
    ...
    def from_samplesheet(
        ...
        verbose: int = 1,
        results_base: Path = Path("examples/Results"),
    ) -> "EcoliResults":
        """
        ...
        for idx, row in df.iterrows():
            ...
            res_path = results_base / sample_name / "kma" / f"{sample_name}.res"
...
# %% ../nbs/49_Ecoli_parser_old.ipynb 15
@call_parse
def ecoli_parser(
...
# %% ../nbs/49_Ecoli_parser_old.ipynb 18
# | eval: true
import sys
from pathlib import Path
import os
...
results_obj = EcoliResults.from_samplesheet(
    samplesheet_path, verbose=1, results_base=Path("test_input/Ecoli")
)
print(results_obj)
# Write to output TSV
...
"""# Create the results dictionary from individual samples
results_dict = {}
sample_cases = ["ERR3528110", "ERR14229029"]

for sample_name in sample_cases:
    res_path = f"test_input/Ecoli/{sample_name}.res"
    summary = EcoliResults.summarize_single_sample(sample_name, res_path, verbose_flag=1)
    results_dict[sample_name] = summary
    print(summary)
    print("THOR SUGGESTIONS")

# Instantiate EcoliResults object
results_obj = EcoliResults(results_dict)
...
# %% ../nbs/49_Ecoli_parser_old.ipynb 19
import os
