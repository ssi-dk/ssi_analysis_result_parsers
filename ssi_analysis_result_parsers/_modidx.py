...
d = { 'settings': { 'branch': 'main',
  ...
  'syms': { 'ssi_analysis_result_parsers.blast_parser': { 'ssi_analysis_result_parsers.blast_parser.allele_matches': ( 'legionella_parser.html#allele_matches',
                                                                                                                       'ssi_analysis_result_parsers/blast_parser.py'),
                                                          'ssi_analysis_result_parsers.blast_parser.presence_absence': ( 'legionella_parser.html#presence_absence',
                                                                                                                         'ssi_analysis_result_parsers/blast_parser.py')},
