...
# %% auto 0
__all__ = ['extract_meningotype', 'extract_cc_from_mlst', 'NmeningitidisResults', 'Spyogenes_parser', 'Spyogenes_batch_parser']
...
class NmeningitidisResults(core.PipelineResults):
    ...
    @classmethod
    def from_tool_paths(cls, meningotype_tsv: Path, sample_name=None):
        """
        ...
        """
        mgk_results = cls.summary(meningotype_tsv=meningotype_tsv)
